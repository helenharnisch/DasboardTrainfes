...
import IcoSecuencialTwo from '../assets/img/iconModos/icon-secuencial-two.svg'
...
class SesionDetailsSecuencial extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  render() {
    return (
      <Main title={"SESSION TEST SECUENCIAL APP"}>
        ...
        <div className="col-md-12">
          ...
          <div className="col-md-12">
            ...
            <div className="col-md-4">
              <CardTrainfes>
                <CardLastSession title={"Penúltima Sesión"} category={"Total Reps."} imgModes={IcoSecuencialTwo} activity={this.state.data.steps_ant_last_session ? this.state.data.steps_ant_last_session : 0} />
              </CardTrainfes>
            </div>
            <div className="col-md-4">
              <CardTrainfes>
                <CardRealSession title={"Última Sesión"} category={"Total Reps."} imgModes={IcoSecuencialTwo} activity={this.state.data.steps_last_session ? this.state.data.steps_last_session : 0} />
              </CardTrainfes>
            </div>
            <div className="col-md-4">
              <CardTrainfes>
                <CardReviewSession title={"Total del mes"} category={"Total Reps."} imgModes={IcoSecuencialTwo} activity={this.state.data.steps_actual_month ? this.state.data.steps_actual_month : 0} />
              </CardTrainfes>
            </div>
          </div>
          <div className="row">
...
export default SesionDetailsSecuencial;
