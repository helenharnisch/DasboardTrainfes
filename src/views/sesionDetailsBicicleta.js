...
import IcoBicicletaTwo from '../assets/img/iconModos/icon-bicicleta-two.svg'
...
import TabSensor from '../components/Tab/TabBicicleta.js';
import axios from 'axios';
import { getUserId } from '../lib/Router'



class SesionDetailsBicicleta extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  render() {
    return (
      <Main title={"SESSION TEST BICICLETA APP"}>
        ...
        <div className="col-md-12">
          ...
          <div className="col-md-12">
            ...
            <div className="col-md-4">
              <CardTrainfes>
                <CardLastSession title={"Penúltima Sesión"} category={"Total Reps."} imgModes={IcoBicicletaTwo} activity={this.state.data.steps_ant_last_session ? this.state.data.steps_ant_last_session : 0} />
              </CardTrainfes>
            </div>
            <div className="col-md-4">
              <CardTrainfes>
                <CardRealSession title={"Última Sesión"} category={"Total Reps."} imgModes={IcoBicicletaTwo} activity={this.state.data.steps_last_session ? this.state.data.steps_last_session : 0} />
              </CardTrainfes>
            </div>
            <div className="col-md-4">
              <CardTrainfes>
                <CardReviewSession title={"Total del mes"} category={"Total Reps."} imgModes={IcoBicicletaTwo} activity={this.state.data.steps_actual_month ? this.state.data.steps_actual_month : 0} />
              </CardTrainfes>
            </div>
          </div>
          <div className="row">
...
export default SesionDetailsBicicleta;
