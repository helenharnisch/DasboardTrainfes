...
class CardLastSession extends Component {
  constructor() {
    super();
  }
      ...
      <div className="row">
          <div className="col-md-7">
            <div className="card-body">
              ...
              <p className="card-category m-0">{ this.props.category }<span><img src={IcoCheckMark} className="img-fluid mx-2" alt="Icon Check MarK"></img></span></p>
...
export default CardLastSession;
