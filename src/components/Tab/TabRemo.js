...
import IcoAyudaRemo from '../../assets/img/iconPerson/ayuda-remo.png'
import IcoListasSensor from '../../assets/img/ListasSensor.svg'


class TabRemo extends Component {
  render() {
    return (
      <Tabs>
        <TabList>
            ...
            <div className="row">
                ...
                <div className="col-md-6 mt-4 d-flex justify-content-center">
                    <CardTrainfes>
                                ...
                                <div style={{ marginBottom: "32px" }}className="d-flex align-items-center d-flex justify-content-center">
                                    <img src={IcoAyudaRemo} className="img-fluid" alt="Ico Ayuda Bicicleta"></img>
                                </div>
