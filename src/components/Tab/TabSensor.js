...
import IcoReminderElectrodeSensor from '../../assets/img/iconPerson/icon-electrode-reminder-sensor.svg'
import IcoListasSensor from '../../assets/img/ListasSensor.svg'
import IcoCanalSensor from '../../assets/img/configuracion-canal-sensor.svg'


class TabSensor extends Component {
  render() {
    return (
      <Tabs>
        <TabList>
            ...
            <div className="col-md-3 mt-4 d-flex justify-content-center">
                <CardTrainfes>
                    ...
                    <div className="d-flex align-items-center d-flex justify-content-center">
                        <img src={IcoReminderElectrodeSensor} className="img-fluid" alt="Ico Reminder Electrode Sensor"></img>
                    </div>
                </CardTrainfes>
            </div>
          ...
          <div className="row">
              <div className="col-md-6 mt-4 d-flex justify-content-center">
                  <CardTrainfes>
                      ...
                      <div className="d-flex align-items-center d-flex justify-content-center">
                          <img src={IcoCanalSensor} className="img-fluid" alt="Ico Canal Sensor"></img>
                          <img src={IcoReminderElectrodeSensor} className="img-fluid ml-5" alt="Ico Reminder Electrode Sensor"></img>
                      </div>
                  </CardTrainfes>
              </div>
              <div className="col-md-6 mt-4">
